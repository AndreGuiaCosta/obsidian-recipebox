...
describe("parseGroceryNoteText", () => {
	it("groups checkbox lines under their preceding ## category heading", () => {
		const text = "## Produce\n- [ ] 2 cups flour\n- [x] 1 apple";
		const sections = parseGroceryNoteText(text, ENGLISH_VOCABULARY);
